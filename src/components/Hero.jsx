...
import profilePhoto from "../images/Gemini_Generated_Image_l3le4hl3le4hl3le (1).png";

export function Hero() {
  return (
    <section className="hero" id="hero">
      <div className="hero-grid" />
      {/* Soft glow orbs – now violet */}
      <div
        className="glow-orb"
        style={{
          width: 600,
      ...
      <div className="hero-inner">
        ...
        <div className="hero-left">
          ...
          <p className="hero-desc reveal">
            AI/ML engineer building real-world applications that combine
            intelligence with practical impact. I focus on creating systems that
          ...
          <div className="hero-social reveal">
            <a
              href="https://github.com/HARSHAVARTHAN27"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/harshavarthan-s-31662b252/"
              target="_blank"
              rel="noopener noreferrer"
              className="social-btn"
              aria-label="LinkedIn"
            ...
            <a
              href="https://www.instagram.com/harshavarthan_official_/"
              target="_blank"
              rel="noopener noreferrer"
              className="social-btn"
            ...
            <a
              href="mailto:harshavarthanshan027@gmail.com"
              className="social-btn"
              aria-label="Email"
            >
              <Mail size={20} />
